while True:
    ...
    Progress =  html.Div([dbc.InputGroup(
                ...
                size="sm",
            ), html.Br(), loading(html.Div(id = 'preview_imgs')), html.Div(id = 'preview_graph')]), #dcc.RadioItems(id = 'Progress_select', value = ''), html.Hr(id = 'hr2'), 
...
#
    ...
    dbc.Button(outline=True, id = 'delete-addclick', active=False, disabled = False, color="danger", className="fas fa-trash-alt")],
            ...
            dbc.Toast(Progress, id="toggle-add-Progress",header="Getting Started",is_open=False,icon="primary",dismissable=True,  style={"maxWidth": "500px"}),
...
dbc.CardBody( 
    ...
    @app.callback(Output("preview_imgs", "children"),
...
#
          ...
          return [  heading_update,'['+header+'] '+msglist, True, True, True,  '', False, s4, open_choose_box, cols]
